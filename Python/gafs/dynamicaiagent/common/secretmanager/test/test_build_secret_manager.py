"""Pytest wrapper that runs the SecretManager test suite against the
compiled secretmanager extension module (.pyd / .so).
...
# parents[5] of this file (…/common/secretmanager/test/test_build_secret_manager.py)
# → Python/ project root.
...
if not _BUILD_COMMON_DIR.is_dir():
    pytest.skip(
        ...
        "Run gafs/dynamicaiagent/common/secretmanager/build_nuitka.py first.",
...
_TEST_MODULE_NAME = "gafs.dynamicaiagent.common.secretmanager.test.test_secret_manager"
_source_test_path = (
    _PYTHON_ROOT
    / "gafs"
    / "dynamicaiagent"
...
from gafs.dynamicaiagent.common.secretmanager.test.test_secret_manager import *  # noqa: F401, F403, E402
