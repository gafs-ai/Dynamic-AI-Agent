"""Run test_surrealdb_local_provider against the Nuitka-compiled databaseprovider.
...
- Then imports all tests from test_surrealdb_local_provider.

Usage:
    # From project Python/ directory, after running build_nuitka.py
    pytest gafs/dynamicaiagent/utils/databaseprovider/test/test_build_surrealdb_local_provider.py -v
"""
...
spec = importlib.util.spec_from_file_location(
    "gafs.dynamicaiagent.utils.databaseprovider.test._source_test_surrealdb_local_provider",
