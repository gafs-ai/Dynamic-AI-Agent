...
def main() -> int:
    ...
    # Path: Python/gafs/dynamicaiagent/utils/databaseprovider/build_nuitka.py
    ...
    candidates = (
        list(out_dir.glob("databaseprovider*.pyd"))
        + list(out_dir.glob("databaseprovider*.so"))
    )
    if not candidates:
    ...
    # so tests can load it by adjusting gafs.dynamicaiagent.utils.__path__.
